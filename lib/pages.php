...
final class PageTemplates
{
    ...
    private static function shell(
        ...
        <body data-page="{$page}">
          ...
          <nav class="{$navClass}" data-nav aria-label="Navigation principale">
            <div class="nav__inner container">
              <a class="nav__logo" data-nav-logo href="{$p}index.html"></a>
              <ul class="nav__links" data-nav-links></ul>
              <div class="nav__actions">
                {$langNav}
                <a class="btn btn--accent btn--pill nav__cta" data-nav-cta href="#booking"></a>
        ...
        {$body}
          ...
          <script defer src="https://cdnjs.cloudflare.com/ajax/libs/lucide/0.454.0/umd/lucide.min.js"></script>

          <script defer src="{$p}config.js"></script>
        ...
        return <<<'HTML'
          ...
          <section class="hero" data-section="hero" aria-label="Présentation">
            ...
            <header class="hero__topbar">
              <button class="glass-pill hero__book-btn" data-hero-book type="button">
                <i data-lucide="mail" aria-hidden="true"></i>
                <span data-hero-cta></span>
              </button>
              <div class="hero__brand">
                <div class="hero__brand-name" data-hero-logo></div>
                <div class="hero__brand-sub"  data-hero-logo-sub></div>
              </div>
              <a class="glass-circle hero__more-btn" href="acces.html"
